...
function AntDesignInstagramOutlined(props) {
  return (
    <svg
      width="1em"
      height="1em"
...
function IcBaselineWhatsapp(props) {
  return (
    <svg
      width="1em"
      height="1em"
      ...
      <div className="absolute xs:bottom-10 bottom-20 w-full flex items-center">
        <Link to="https://github.com/nisar1406" target="blank">
          <motion.div
            ...
            initial={{ x: "calc(100vw - 40%)" }}
            animate={{ x: 100 }}
            transition={{ duration: 1.5, delay: 0.5 }}
          >
            <RiGithubFill height={30} width={30} />
          </motion.div>
        </Link>
        <Link to="https://www.linkedin.com/in/nisar1406" target="blank">
          <motion.div
            className="social-icon flex items-center"
            style={{ marginRight: 25 }}
            initial={{ x: "calc(100vw - 40%)" }}
          ...
          >
            <LaLinkedin height={30} width={30} />
          </motion.div>
        </Link>
        <Link to="https://www.instagram.com/nisar1406__" target="blank">
          <motion.div
            className="social-icon flex items-center"
            style={{ marginRight: 25 }}
            initial={{ x: "calc(100vw - 40%)" }}
            ...
            transition={{ duration: 1.5, delay: 0.5 }}
          >
            <AntDesignInstagramOutlined height={30} width={30} />
          </motion.div>
        </Link>
        <Link target="blank">
          <motion.div
          ...
          >
            <IcBaselineWhatsapp height={30} width={30} />
          </motion.div>
        </Link>
      </div>
    </motion.section>
